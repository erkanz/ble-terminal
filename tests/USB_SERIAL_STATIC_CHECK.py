...
checks = {
    ...
    'USB RTX1 is direct serial stream not fake GATT routing': 'WRITE_MODE=RAW_BINARY_STREAM' in usb and 'BLE_HANDSHAKE=NOT_APPLICABLE' in usb and 'GattCharacteristic' not in usb and 'OemHandshake' not in usb,
