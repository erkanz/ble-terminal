...
checks = {
    ...
    'loopback network tests cover RX TX multi-client reconnect': all(x in tests for x in ['BLE->TCP preserves raw KISS bytes exactly', 'TCP stream bytes reach BLE writer unchanged', 'multiple TCP clients', 'fresh BLE connection context']),
}
